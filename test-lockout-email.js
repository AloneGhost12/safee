// Test the account lockout email functionality
const nodemailer = require('nodemailer');

async function testAccountLockoutEmail() {
  console.log('🧪 Testing Account Lockout Email...');
...
<body>
    <div class="container">
        ...
        <div class="info-box">
            ...
            <ul>
                ...
                <li><strong>Device:</strong> Chrome/Windows</li>
            </ul>
        </div>
        ...
        <div class="warning">
            ...
            <ul>
                <li>Your account will automatically unlock after <strong>5 minutes</strong></li>
  ...
  try {
    console.log('📧 Sending lockout alert email...');
    const result = await transporter.sendMail({
      ...
      html: html,
      text: 'Your Tridex account has been temporarily locked due to multiple failed login attempts. Please wait 5 minutes before trying again.'
    });

    console.log('✅ Lockout alert email sent successfully!');
    console.log('📧 Message ID:', result.messageId);
    console.log('📬 Check your email inbox for the security alert');
  } catch (error) {
    console.error('❌ Failed to send lockout alert email:', error.message);
  }
}

testAccountLockoutEmail();
